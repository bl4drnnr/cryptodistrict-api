...
var LocalStrategy = /** @class */ (function (_super) {
    ...
    function LocalStrategy(userService) {
    ...
    LocalStrategy.prototype.validate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.validateUser({ email: email, password: password })];
                    case 1:
                        user = _a.sent();
                        if (!user)
                            throw new common_1.UnauthorizedException('wrong-password', 'Wrong password!');
